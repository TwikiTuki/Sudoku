...
If you want to run it locally you will need a running server.  One easy option to set it is: ``` python3 -m http.server ``` but have in mind that running a server this way is discouraged in a production environments.
